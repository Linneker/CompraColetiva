...
{
    public class EncomendaUsuarioRepository : BaseRepository<EncomendaUsuario>, IEncomendaUsuarioRepository
    {
        public EncomendaUsuarioRepository(Context db) : base(db)
        {
        }
    }
}
